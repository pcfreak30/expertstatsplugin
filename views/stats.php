<?php /** @var $account_details */ ?>
<?php /** @var $clients_data */ ?>
<?php /** @var $account_details */ ?>
<?php /** @var $balance */ ?>
<?php /** @var $average_task_size */ ?>
<?php /** @var $all_averages */ ?>
<?php /** @var $is_compare */ ?>
<?php /** @var $chart_display_method */ ?>
<?php /** @var $compare_averages */ ?>
<?php /** @var $averages */ ?>
<?php /** @var $preferred_count */ ?>
<div class="wrap cable_stats_wrap">
	...
	<div class="flex-row first-stats-row">
		...
		<div class="box user-info">
			<div class="avatar">
				...
				echo $account_details['user']['avatar']['large_url']; ?>"/>
			...
			<div class="column_inner">
				...
				<div class="footerdata">
					<span class="label"><?php echo __( 'Since', 'wpcable' ); ?></span>: <span
							class="value"><?php echo $first_task['dateadded']; ?></span>
				</div>
			</div>
		</div>
	...
	<div class="flex-row box date-filters">
		<form method="get" id="date_form" data-start-year="<?php echo $first_year; ?>"
			...
			<div class="section">
				<img class="compareicon"
					 src="<?php echo esc_url( plugins_url( 'assets/images/calendar-add.svg', dirname( __FILE__ ) ) ); ?>"
					 width="16" height="16" alt="<?php echo __( 'compare dates', 'wpcable' ); ?>"
					 title="<?php echo __( 'compare dates', 'wpcable' ); ?>">
			</div>
			<div class="section">
				<div class="datefield">
				...
				<div class="datefield compareto <?php echo $is_compare; ?>">
					<label class="label"
						   for="compare_date_from"><?php echo __( 'Compare Start date', 'wpcable' ); ?></label>
			...
			<div class="section">
				...
				<div class="datefield compareto <?php echo $is_compare; ?>">
					<label class="label"
						   for="compare_date_to"><?php echo __( 'Compare End date', 'wpcable' ); ?></label>
